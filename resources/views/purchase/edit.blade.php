                    ...
                    <tbody class="divide-y" x-ref="tbody">
                        <template x-for="(line, idx) in lines" :key="line.key">
                            <tr>
                                ...
                                <td class="px-3 py-2">
                                    <input type="number" step="0.00000001" min="0" class="w-28 rounded-lg border-gray-200" :name="`lines[${idx}][purchase_price]`" x-model="line.purchase_price" placeholder="Pending">
