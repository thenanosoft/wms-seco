            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="timezone" class="mt-1 w-full rounded-lg border-gray-200">
                        <option value="Asia/Karachi" {{ old('timezone', $timezone ?? 'Asia/Karachi') === 'Asia/Karachi' ? 'selected' : '' }}>Asia/Karachi</option>
                    </select>
    ...
    <div class="rounded-xl border bg-white p-4 sm:p-6">
        <div class="flex items-start justify-between gap-4">
            ...
            <div class="flex gap-2">
                <a href="{{ route('pending_prices.index') }}" class="rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800">Pending Prices</a>
                <a href="{{ route('reports.valuation.index') }}" class="rounded-lg border border-gray-200 px-4 py-2 text-sm hover:bg-gray-50">FIFO Valuation</a>
            </div>
        </div>
    </div>
        ...
        <form method="GET" action="{{ route('export.ledger.csv') }}" class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="q" value="{{ request('q') }}" class="mt-1 w-full rounded-lg border-gray-200" placeholder="Name or Ref#">
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div class="rounded-lg border border-gray-200 p-4">
                <div class="flex items-start justify-between gap-3">
                    ...
                    <a href="{{ route('imports.samples', ['type' => 'groups']) }}" class="text-sm text-indigo-600 hover:underline">Download sample</a>
                </div>
                <form method="POST" action="{{ route('imports.run', ['type' => 'groups']) }}" enctype="multipart/form-data" class="mt-3 flex gap-2">
                    @csrf
            ...
            <div class="rounded-lg border border-gray-200 p-4">
                <div class="flex items-start justify-between gap-3">
                    ...
                    <a href="{{ route('imports.samples', ['type' => 'items']) }}" class="text-sm text-indigo-600 hover:underline">Download sample</a>
                </div>
                <form method="POST" action="{{ route('imports.run', ['type' => 'items']) }}" enctype="multipart/form-data" class="mt-3 flex gap-2">
                    @csrf
                    <input type="file" name="file" accept=".csv" class="w-full rounded-lg border-gray-200">
                    <button class="rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white hover:bg-gray-800">Import</button>
                </form>
            ...
            <div class="rounded-lg border border-gray-200 p-4">
                <div class="flex items-start justify-between gap-3">
                    ...
                    <a href="{{ route('imports.samples', ['type' => 'purchases']) }}" class="text-sm text-indigo-600 hover:underline">Download sample</a>
                </div>
                <form method="POST" action="{{ route('imports.run', ['type' => 'purchases']) }}" enctype="multipart/form-data" class="mt-3 flex gap-2">
                    @csrf
                    <input type="file" name="file" accept=".csv" class="w-full rounded-lg border-gray-200">
                    <button class="rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white hover:bg-gray-800">Import</button>
                </form>
            ...
            <div class="rounded-lg border border-gray-200 p-4">
                <div class="flex items-start justify-between gap-3">
                    ...
                    <a href="{{ route('imports.samples', ['type' => 'issues']) }}" class="text-sm text-indigo-600 hover:underline">Download sample</a>
                </div>
                <form method="POST" action="{{ route('imports.run', ['type' => 'issues']) }}" enctype="multipart/form-data" class="mt-3 flex gap-2">
                    @csrf
                    <input type="file" name="file" accept=".csv" class="w-full rounded-lg border-gray-200">
                    <button class="rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white hover:bg-gray-800">Import</button>
                </form>
