                    ...
                    <tr>
                        ...
                        <td class="px-3 py-2 text-right">
                            <div class="inline-flex items-center gap-2">
                                <a href="<?php echo e(route('returns.purchase.edit', $r->purchase_return_transaction_id)); ?>" class="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 hover:bg-gray-50" title="Edit">
                                ...
                                <form action="<?php echo e(route('returns.purchase.destroy', $r->purchase_return_transaction_id)); ?>" method="POST" onsubmit="return confirm('Delete this return? Stock will be restored back.')">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/farhanellahi/Development/web/laravel/wms/resources/views/returns/purchase/index.blade.php ENDPATH**/ ?>