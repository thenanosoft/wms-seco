...
<div class="max-w-5xl mx-auto space-y-6">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="<?php echo e(route('purchases.edit', $purchase)); ?>" class="rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800">Edit</a>
            <form method="POST" action="<?php echo e(route('purchases.destroy', $purchase)); ?>" onsubmit="return confirm('Delete this purchase? This is only allowed when nothing is issued from it.');">
                <?php echo csrf_field(); ?>
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-4 sm:p-6">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
            ...
            <div><span class="text-gray-500">Reference</span><div class="font-medium"><?php echo e($purchase->reference_no ?: '-'); ?></div></div>
                ...
                <?php $__currentLoopData = $purchase->lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="px-4 py-2 text-right">
                            <?php if($line->purchase_price === null): ?>
                            ...
                            <?php else: ?>
                                <?php echo e(number_format((float) $line->purchase_price, 4)); ?>

                            <?php endif; ?>
                        </td>
                        <td class="px-4 py-2 text-right"><?php echo e($line->specification ?: ''); ?></td>
                        <td class="px-4 py-2 text-right"><?php echo e(number_format((float) ($line->line_total ?? 0), 4)); ?></td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Data/Development/web/laravel/wms/resources/views/purchase/show.blade.php ENDPATH**/ ?>