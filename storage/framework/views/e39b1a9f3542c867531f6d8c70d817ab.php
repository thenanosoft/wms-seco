...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="rounded-xl border bg-white p-4">
            ...
            <div class="mt-2 text-2xl font-semibold"><?php echo e(number_format($purchase->total, 0)); ?></div>
        ...
        <div class="rounded-xl border bg-white p-4">
            ...
            <div class="mt-2 text-2xl font-semibold"><?php echo e(number_format($issue->total, 0)); ?></div>
        ...
        <div class="rounded-xl border bg-white p-4">
            ...
            <div class="text-xs text-gray-600 mt-1">Value: <?php echo e(number_format($returnIn->total, 0)); ?></div>
            <div class="mt-3">
        ...
        <div class="rounded-xl border bg-white p-4">
            ...
            <div class="text-xs text-gray-600 mt-1">Value: <?php echo e(number_format($returnOut->total, 0)); ?></div>
            <div class="mt-3">
            ...
            <div class="rounded-xl border bg-white p-5">
                ...
                <div class="mt-3">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-2 text-sm">
                        <div class="flex items-center justify-between"><span class="text-gray-600">Total In Value</span><span class="font-semibold"><?php echo e(number_format($inValue, 0)); ?></span></div>
                        <div class="flex items-center justify-between"><span class="text-gray-600">Total Out Value</span><span class="font-semibold"><?php echo e(number_format($outValue, 0)); ?></span></div>
                        <div class="flex items-center justify-between"><span class="text-gray-600">Balance Value</span><span class="font-semibold"><?php echo e(number_format($balanceValue, 0)); ?></span></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wms\resources\views/dashboard/index.blade.php ENDPATH**/ ?>