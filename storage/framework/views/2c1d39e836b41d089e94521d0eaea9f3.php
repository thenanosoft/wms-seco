            ...
            <tbody class="divide-y">
                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 text-right"><?php echo e(number_format((float)$r->quantity, 4)); ?></td>
                        <td class="px-4 py-2 text-right">
                            <?php if($r->purchase_price === null): ?>
                            ...
                            <?php else: ?>
                                <?php echo e(number_format((float)$r->purchase_price, 4)); ?>

                            <?php endif; ?>
                        </td>
                        <td class="px-4 py-2 text-right font-semibold">
                            <?php echo e(number_format((float)$r->line_total, 4)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Data/Development/web/laravel/wms/resources/views/purchase/items-index.blade.php ENDPATH**/ ?>