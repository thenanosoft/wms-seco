<div class="h-full flex flex-col">
    <div class="px-5 py-4 border-b border-gray-200">
        <div class="text-base font-semibold leading-tight"><?php echo e(config('app.name')); ?></div>
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4">
        <div class="space-y-1">
            ...
            <a href="<?php echo e(route('dashboard')); ?>"
               ...
               <?php echo e(request()->routeIs('dashboard') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-100'); ?>">
            ...
            <div class="mt-4">
                ...
                <a href="<?php echo e(route('purchases.index')); ?>"
                   ...
                   <?php echo e(request()->routeIs('purchases.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-100'); ?>">
                    <svg class="h-5 w-5 flex-none opacity-90" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                        <path d="M12 2v20" />
                        <path d="M5 9l7-7 7 7" />
                    </svg>
                ...
                <a href="<?php echo e(route('issues.index')); ?>"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium
                   <?php echo e(request()->routeIs('issues.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-100'); ?>">
                    <svg class="h-5 w-5 flex-none opacity-90" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                        <path d="M12 22V2" />
            ...
            <?php if($isAdmin): ?>
                <div class="mt-4">
                    ...
                    <a href="<?php echo e(route('stock.index')); ?>"
                       class="mt-2 flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium
                       <?php echo e(request()->routeIs('stock.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-100'); ?>">
                        <svg class="h-5 w-5 flex-none opacity-90" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                            <path d="M4 19V5" />
                            <path d="M4 19h16" />
                            <path d="M8 15V9" />
                    ...
                    <a href="<?php echo e(route('groups.index')); ?>"
                       class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium
                       <?php echo e(request()->routeIs('groups.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-100'); ?>">
                        <svg class="h-5 w-5 flex-none opacity-90" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                            <path d="M4 7h16" />
                            <path d="M4 12h16" />
                            <path d="M4 17h16" />
                    ...
                    <a href="<?php echo e(route('items.index')); ?>"
                       class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium
                       <?php echo e(request()->routeIs('items.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-100'); ?>">
                        <svg class="h-5 w-5 flex-none opacity-90" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                    ...
                    <a href="<?php echo e(route('settings.index')); ?>"
                       class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium
                       <?php echo e(request()->routeIs('settings.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-100'); ?>">
                        <svg class="h-5 w-5 flex-none opacity-90" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                    ...
                    <a href="<?php echo e(route('backup.index')); ?>"
                       class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium
                       <?php echo e(request()->routeIs('backup.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-100'); ?>">
                        <svg class="h-5 w-5 flex-none opacity-90" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                            <path d="M12 6V3" />
                            <path d="M8 3h8" />
                            <path d="M6 6h12" />
        ...
        <a href="<?php echo e(route('profile.index')); ?>" class="block">
            <div class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-gray-100 transition-colors bg-gray-200">
                ...
                <div class="flex-1 min-w-0">
                    <div class="text-sm font-semibold text-gray-900 truncate"><?php echo e(auth()->user()->name); ?></div>
                    <div class="text-xs text-gray-500 truncate capitalize"><?php echo e(auth()->user()->role); ?></div>
                </div>
            </div>
        </a>
    </div>
</div>
<?php /**PATH /Users/farhanellahi/Development/web/laravel/wms/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>