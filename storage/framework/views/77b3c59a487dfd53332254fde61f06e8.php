...
<body class="bg-gray-50 text-gray-900">
    ...
    <div class="max-w text-center px-4 py-3 text-md text-gray-600">
        <div>
            © <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?> - Designed by Farhan Ellahi Owned by Nanosoft
        </div>
    </div>
</footer>

</body></html>
<?php /**PATH /Users/Data/Development/web/laravel/wms/resources/views/layouts/app.blade.php ENDPATH**/ ?>