            ...
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $summary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-right"><?php echo e(number_format((float)$r->value, 4)); ?></td>
                            <td class="px-4 py-3">
                ...
                <tfoot class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-right font-semibold"><?php echo e(number_format((float)$grandTotal, 4)); ?></th>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="px-3 py-2 text-right"><?php echo e(number_format((float)$b->unit_price_display, 4)); ?></td>
                            <td class="px-3 py-2 text-right"><?php echo e(number_format((float)$b->value, 4)); ?></td>
                            <td class="px-3 py-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Data/Development/web/laravel/wms/resources/views/reports/valuation.blade.php ENDPATH**/ ?>