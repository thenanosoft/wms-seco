    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div class="flex items-center gap-2">
            ...
            <?php if(auth()->user()?->role === 'admin'): ?>
                <a href="<?php echo e(route('issues.edit', $issue)); ?>"
                ...
                <form action="<?php echo e(route('issues.destroy', $issue)); ?>" method="POST"
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y">
                <?php $__empty_1 = true; $__currentLoopData = ($lines ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="px-4 py-2 text-right">
                            ...
                            <?php else: ?>
                                <?php echo e(number_format((float)$line->issue_price, 4)); ?>

                            <?php endif; ?>
                        </td>
                        <td class="px-4 py-2"><?php echo e($line->specification ?: ''); ?></td>
                        <td class="px-4 py-2 text-right"><?php echo e(number_format((float)$line->net_line_total, 4)); ?></td>
                    </tr>
                ...
                <tr class="bg-gray-50 font-semibold">
                    ...
                    <td class="px-4 py-2 text-right"><?php echo e(number_format((float)($totals->total_qty ?? 0), 4)); ?></td>
                    <td class="px-4 py-2 text-right"><?php echo e(number_format((float)($totals->total_returned ?? 0), 4)); ?></td>
                    <td class="px-4 py-2 text-right"><?php echo e(number_format((float)($totals->total_remaining ?? 0), 4)); ?></td>
                    <td class="px-4 py-2"></td>
                    <td class="px-4 py-2"></td>
                    <td class="px-4 py-2 text-right"><?php echo e(number_format((float)($totals->total_net_amount ?? 0), 4)); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Data/Development/web/laravel/wms/resources/views/issue/show.blade.php ENDPATH**/ ?>