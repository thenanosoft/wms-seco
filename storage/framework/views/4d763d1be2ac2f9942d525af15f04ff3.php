                            ...
                            <tr>
                                ...
                                <td class="px-3 py-2">
                                    ...
                                    <div class="mt-1 text-xs text-gray-600">
                                        Estimated (next FIFO batch)
                                    </div>
                                    <div class="mt-1 text-xs text-red-600" x-show="line.price_pending" x-cloak>Price pending (invoice not confirmed)</div>
                                </td>
...
function issueForm(groups, items) {
    ...
    line.display_price = Number(it.fifo_next_price || 0);
    line.price_pending = Boolean(it.fifo_price_pending);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Data/Development/web/laravel/wms/resources/views/issue/create.blade.php ENDPATH**/ ?>