...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="rounded-xl border bg-white p-4">
            ...
            <div class="mt-2 text-2xl font-semibold"><?php echo e(number_format((float)$purchase->total, 4)); ?></div>
        ...
        <div class="rounded-xl border bg-white p-4">
            ...
            <div class="mt-2 text-2xl font-semibold"><?php echo e(number_format((float)$issue->total, 4)); ?></div>
        ...
        <div class="rounded-xl border bg-white p-4">
            ...
            <div class="mt-2 text-2xl font-semibold"><?php echo e(number_format($returnIn->qty, 0)); ?></div>
            <div class="text-xs text-gray-600 mt-1">Value: <?php echo e(number_format((float)$returnIn->total, 4)); ?></div>
            <div class="mt-3">
        ...
        <div class="rounded-xl border bg-white p-4">
            ...
            <div class="mt-2 text-2xl font-semibold"><?php echo e(number_format($returnOut->qty, 0)); ?></div>
            <div class="text-xs text-gray-600 mt-1">Value: <?php echo e(number_format((float)$returnOut->total, 4)); ?></div>
            <div class="mt-3">
            ...
            <div class="rounded-xl border bg-white p-5">
                ...
                <div class="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
                    ...
                    <div class="flex gap-2">
                        <a id="exportGo" href="<?php echo e(route('export.stock.pdf')); ?>" class="w-full text-center rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800">Export</a>
                    </div>
                </div>
                ...
                <script>
                    (function () {
                        const routes = {
                            stock: { csv: "<?php echo e(route('export.stock.csv')); ?>", pdf: "<?php echo e(route('export.stock.pdf')); ?>" },
                            purchases: { csv: "<?php echo e(route('export.purchases.csv')); ?>", pdf: "<?php echo e(route('export.purchases.pdf')); ?>" },
                            issues: { csv: "<?php echo e(route('export.issues.csv')); ?>", pdf: "<?php echo e(route('export.issues.pdf')); ?>" },
                            issue_returns: { csv: "<?php echo e(route('export.issue_returns.csv')); ?>", pdf: "<?php echo e(route('export.issue_returns.pdf')); ?>" },
                            purchase_returns: { csv: "<?php echo e(route('export.purchase_returns.csv')); ?>", pdf: "<?php echo e(route('export.purchase_returns.pdf')); ?>" },
                            ledger: { csv: "<?php echo e(route('export.ledger.csv')); ?>", pdf: null },
                        };
            ...
            <div class="rounded-xl border bg-white p-5">
                ...
                <div class="mt-3">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-2 text-sm">
                        <div class="flex items-center justify-between"><span class="text-gray-600">Total In Value</span><span class="font-semibold"><?php echo e(number_format((float)$inValue, 4)); ?></span></div>
                        <div class="flex items-center justify-between"><span class="text-gray-600">Total Out Value</span><span class="font-semibold"><?php echo e(number_format((float)$outValue, 4)); ?></span></div>
                        <div class="flex items-center justify-between"><span class="text-gray-600">Balance Value</span><span class="font-semibold"><?php echo e(number_format((float)$balanceValue, 4)); ?></span></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Data/Development/web/laravel/wms/resources/views/dashboard/index.blade.php ENDPATH**/ ?>